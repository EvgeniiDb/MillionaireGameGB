...
//        tableView.endUpdates()
    ...
    @IBAction func saveQuestions(_ sender: Any) {
        ...
        if cell.answerSwitcher4.isOn {
            ...
            questionCaretaker.save(items: [question])
        }
...
extension QuestionsViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "questionRow", for: indexPath)
                as? NewQuestionTableViewCell else { return UITableViewCell() }
