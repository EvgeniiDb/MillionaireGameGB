...
class GameViewController: UIViewController {
    ...
    @objc func wrongAnswerHandle(sender: UIButton) {
        ...
        showAnswerAlert(title: "Увы!", text: "Ответ не верный!", buttonText: "Закончить игру")
    }
    ...
    @objc func correctAnswerHandle(sender: UIButton) {
        ...
        if questions.indices.contains(currentQuestionIndex+1) {
            ...
            gameDataDelegate?.saveResult()
            showAnswerAlert(title: "Ура!!!", text: "Вы ответили правильно на все вопроты и выиграли миллион!", buttonText: "Поздравляем с выигрышем!")
        }
    }
    ...
    @IBAction func hintSpectators(_ sender: UIButton) {
        sender.isEnabled = false
        showHintAlert(title: "Помощь зала", text: "Большинство зрителей считают, что правильный ответ - \(correctAnswer)")
    }
    ...
    @IBAction func exitAction(_ sender: UIButton) {
        ...
        let continueAction = UIAlertAction(title: "Продолжить игру", style: .cancel)
